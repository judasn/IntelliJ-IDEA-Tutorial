...
- [2. 教程介绍（新用户必看）](about-this-tutorial.md)
- [3. 安装环境：Windows](windows-install.md)
- [4. 安装环境：Ubuntu](ubuntu-install.md)
- [5. 安装环境：Mac](mac-install.md)
- [6. 安装环境总结（新用户必看）](install-summarize.md)
- [7. 首次运行向导（新用户必看）](first-run-wizard.md)
- [8. 安装后生成的目录说明、IDE 设置云同步（新用户必看）](installation-directory-introduce.md)
- [9. UI 界面（新用户必看）](interface-introduce.md)
